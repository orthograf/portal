			...
			<tr>
				<td style="padding: 25px 60px 25px 60px;"; width="474" colspan="2">				
					<div style="border-bottom: 1px solid #D8DFE6; color: #6e6b92;">
						Новый комментарий в теме <strong>{$oTopic->getTitle()|escape:'html'}</strong>
					</div>
								...
								<td style="vertical-align: top; width: 90px;">
									...
									<br><strong>
											<a href="{$oUserComment->getProfileUrl()}">
												{if $oUserComment->getProfileName()}{$oUserComment->getProfileName()}{else}{$oUserComment->getDisplayName()}{/if}
											</a>
										</strong>
									</div>
								</td>
					...
					{if $sSubscribeKey}						
						<a href="{router page='subscribe'}unsubscribe/{$sSubscribeKey}/" style="color: #6e6b92; font-size: 12px;">
