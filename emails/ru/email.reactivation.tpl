			...
			<tr>
				<td style="padding: 25px 60px 25px 60px;"; width="474" colspan="2">				
					<div style="border-bottom: 1px solid #D8DFE6; color: #6e6b92;">
						Вы запросили повторную активацию на сайте {Config::Get('view.name')}
					</div>														
					<div style="padding: 23px;">					
					Ссылка на активацию аккаунта:
					<br><a href="{router page='registration'}activate/{$oUser->getActivateKey()}/">{router page='registration'}activate/{$oUser->getActivateKey()}/</a>
					</div>					
				</td>
			</tr>
